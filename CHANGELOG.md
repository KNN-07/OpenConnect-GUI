...
- Corrected hosted native build failures, pinned and bundled Windows pthreads, and moved macOS control/network-monitor endpoints beneath protected `/private/var/db` ancestors.
