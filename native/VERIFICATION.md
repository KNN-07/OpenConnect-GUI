...
| Windows x86_64 | Native Windows/MSVC Rust and MinGW OpenConnect builds exercised. Actual GUI and CLI packages passed installation, all seven protocols, healthy doctor/running-service checks and idle uninstall on GitHub-hosted Windows 2022 runners. Wintun/NRPT networking, desktop and tunnel acceptance are not inferred from those idle checks. |
